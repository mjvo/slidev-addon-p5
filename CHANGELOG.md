...
- Surface iframe dependency script load failures with the failing URL, including `externalP5Libs` entries, instead of leaving a missing dependency unexplained.
...
- Added unit and Playwright coverage for failed iframe dependency script diagnostics.
- Expanded multi-sketch runner coverage to verify iframe ownership remains stable through rapid alternating reruns.
